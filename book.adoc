...
== C++
include::C++/C++常见知识点.adoc[C++常见知识点总结]

include::C++/常用编程语句.adoc[常用编程语句]
include::C++/模板编程.adoc[模板编程]

<<<

== go

include::go/go语言基础.adoc[go基础]
include::go/go常见问题.adoc[go常见问题]
include::go/内存管理.adoc[内存管理]
...
include::分布式/分布式常见知识点.adoc[etcd]

<<<

== MQ
include::MQ/kafka.adoc[kafka]
...
include::算法/常见算法.adoc[常见算法]
include::算法/设计模式.adoc[设计模式]
...
include::utils/cmakelists.adoc[cmakelists]
